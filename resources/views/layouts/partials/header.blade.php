                    ...
                    <div class="dropdown header-profile2 ">
                        ...
                        <a class="nav-link user-profile" href="javascript:void(0);" role="button"
                            ...
                            <div class="header-info2 d-flex align-items-center">
                                ...
                                @else
                                    <svg class="rounded" width="35" height="25" viewBox="0 0 24 24"
                                ...
                                <div class="d-flex align-items-center sidebar-info">
                                    <div class="user-info">
                                        <span
                                            class="font-w500 d-block  fs-5 text-white">{{ Auth::user()->username }}</span>
                                        <small
                                            class="text-end font-w400">{{ auth()->user()->getRoleNames()->first() }}</small>
                                    </div>
