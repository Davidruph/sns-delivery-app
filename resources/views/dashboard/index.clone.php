            ...
            {{-- <div class="col-xl-4 col-lg-4 col-md-12">
                    <div class="card">
                        <div class="card-header border-0 pb-4 arrow">
                            ...
                            <svg class="theme-col" width="45" height="45" viewBox="0 0 52 52" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="card bg-transparent contacts mb-1">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="text" id="PersonName" class="form-control w-100 mb-3"
                                                        placeholder="Username">
                                                    <label for="PersonPosition" class="form-label d-block">Enter
                                                        Position</label>
                                                    <input type="text" id="PersonPosition" class="form-control w-100"
                            ...
                            <div class="card-body loadmore-content dz-scroll recent-activity-wrapper px-3  py-3"
                                ...
                                <div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
                                    ...
                                    <div class="ms-2">
                                        <h6 class="font-w500 fs-16 mb-0"><a href="app-profile.html">Bella Brownlee</a>
                                        </h6>
                                ...
                                <div class="d-flex py-sm-3 py-1 px-3 align-items-center student">
                                    ...
                                    <div class="ms-2">
                                        <h6 class="font-w500 fs-16 mb-0"><a href="app-profile.html">Chynthia Lawra</a>
                                        </h6>
                            ...
                            <div class="card-footer text-center border-0 pt-0">
                                <a href="javascript:void(0);" class="btn btn-block   dz-load-more" id="RecentActivity"
